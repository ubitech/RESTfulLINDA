...
public class ForecastingRDFGenerator extends RDFGenerator {
    ...
    public Model generateRDFModel(Analytics analytics, Rengine re) {
        ...
        Resource software_statement = model.createResource(ds + "RESTfulLIDA_analytics_software");
        Resource linda_user_statement = model.createResource(ds + "eleni");

        Resource analytic_process_statement = model.createResource(ds + "analytic_process");
        analytic_process_statement.addProperty(OWL.versionInfo, "1.0.0");
