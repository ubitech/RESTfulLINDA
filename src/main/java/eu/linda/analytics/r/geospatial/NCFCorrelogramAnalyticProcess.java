    ...
    public void train(Analytics analytics) {
        try {
            ...
            if (exists_geo_info.asString().equalsIgnoreCase("FALSE")) {
                ...
                System.out.println("correlation_percent" + correlation_percent.asString());
            ...
            Logger.getLogger(NCFCorrelogramAnalyticProcess.class.getName()).log(Level.SEVERE, ex_message, ex);
